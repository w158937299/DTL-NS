...
def parse_args():
    ...
    parser.add_argument("--warmup", type=int, default=100, help="dens parameters")

    parser.add_argument("--ps", type=str, default='enhance')
    parser.add_argument("--ps_param", type=str, default='enhance_dtl_fni')
    parser.add_argument("--ns", type=str, default='dtl', help="rns,dns,dns_mn,dens,mix,cns,ahns, dtl")
    parser.add_argument("--n_negs", type=int, default=10, help="number of candidate negative")
    parser.add_argument("--alpha_co", type=float, default=0.1, help="alpha_co")
    parser.add_argument("--alpha_se", type=float, default=0.3, help="alpha_semantic")

    parser.add_argument("--p", type=int, default=-2, help="power")
    parser.add_argument("--alpha", type=float, default=1.0, help="alpha")
    parser.add_argument("--beta", type=float, default=0.1, help="beta")

    parser.add_argument("--topk", type=int, default=5, help="n for dns_mn")
    parser.add_argument("--gamma", type=float, default=0.5, help="trade-off parameter of dens")

    parser.add_argument("--cuda", type=bool, default=True, help="use gpu or not")
    parser.add_argument("--gpu_id", type=int, default=0, help="gpu id")
    parser.add_argument('--Ks', nargs='?', default='[5, 10, 20,30,50]',
